...
**Urban Lunch v 1.0** | **Pruebas de aplicaciones móviles (2025)** . Ejecución de pruebas de aplicaciones móviles en Android Studio. Configuración de dispositivos Android en el simulador. Reporte de defectos en Jira, Informe de pruebas, análisis y conclusiónes.
